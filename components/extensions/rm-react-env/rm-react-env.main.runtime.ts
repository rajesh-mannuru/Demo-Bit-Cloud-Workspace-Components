...
export class RmReactEnvMain {
  ...
  static async provider([react, envs]: [ReactMain, EnvsMain]) {
    ...
    const RmReactEnvEnv = react.compose([
      /**
    ...
    envs.registerEnv(RmReactEnvEnv);
    return new RmReactEnvMain();
  }
}

RmReactEnvAspect.addRuntime(RmReactEnvMain);
